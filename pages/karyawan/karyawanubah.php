        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="misal: Puspa" value="<?php echo $row['nama'] ?>" required>
                </div>
                <div class="mb-3">
                    <label for="tanggal_mulai" class="form-label">Tanggal Mulai Bekerja</label>
                    <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" value="<?php echo $row['tanggal_mulai'] ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="gaji_pokok" class="form-label">Gaji Pokok</label>
                    <input type="number" class="form-control" id="gaji_pokok" name="gaji_pokok" value="<?php echo $row['gaji_pokok'] ?>" readonly>
                </div>

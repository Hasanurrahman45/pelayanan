    ...
    <div class="col">
        ...
        ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-exlamation-circle"></i>
        ...
        if (!$result || mysqli_num_rows($result) == 0) {
            echo '<meta http-equiv="refresh" content="30;url=?page=pilihkaryawanpenggajian">';
        }
        ...
        <div class="card px-3 mt-3">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="tahun" id="tahun" required maxlength="4">
                </div>
                <div class="col mb-3">

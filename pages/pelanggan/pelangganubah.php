                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <select class="form-select" name="jekel" id="jekel">
                            <option value="Laki-Laki" <?php if ($row['jekel'] == "Laki-Laki") echo 'selected'; ?>>Laki-Laki</option>
                            <option value="Perempuan" <?php if ($row['jekel'] == "Perempuan") echo 'selected'; ?>>Perempuan</option>
                        </select>
                    </div>
                    <div class="mb-3 mt-3">
